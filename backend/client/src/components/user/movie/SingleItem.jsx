...
class SingleItem extends Component {
  ...
  getMediaInfo = () => {
    ...
    axios
    .get(`/api/movie/details/${bookmark.media_id}`)
    .then(res => {
      this.setState({
        media: res.data,
  ...
  handleButton = e => {
    ...
    axios
    .post('/users/movie/progress', { progress: progress, id: id })
    .then(res => {
      this.setState({
        progress: progress
      })
      ...
      <div className='SingleItem' >
        ...
        <div>
          ...
          <div className='progressbar-container' style={{width:'300px', height:'25px', backgroundColor:'black'}} >
            <div className='progressbar' style={{width: `${(progress/1) * 300}px`, height: '25px', backgroundColor:'darkgreen'}}/>
          </div>
          <div>
            {
              edit
